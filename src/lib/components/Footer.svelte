...
<footer
  class="relative bg-brandDark text-brandLight/40 py-16 border-t border-white/5 pb-32 sm:pb-16 overflow-hidden"
>
  <div
    class="absolute bottom-0 right-0 w-[300px] h-[300px] bg-brandBlue/5 blur-[100px] rounded-full -z-10"
  ></div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-16 mb-16">
      <div class="space-y-6">
        <a
          ...
          aria-label="HorseMaster Početna"
        >
          <span
            class="text-xl font-black tracking-[0.3em] text-brandLight uppercase italic"
          >
        ...
        <div class="flex space-x-6 pt-4">
          <a
            ...
            class="hover:text-brandBlue transition-all transform hover:-translate-y-1"
            aria-label="Facebook"
          >
      ...
      <div>
        ...
        <ul class="space-y-4 text-[10px] font-black uppercase tracking-[0.2em]">
          <li>
            <a
              href="/"
              class="hover:text-brandBlue transition-colors flex items-center group"
              ><span
      ...
      <div>
        ...
        <ul class="space-y-5 text-[10px] font-black uppercase tracking-[0.2em]">
          <li class="flex items-start group">
            <div
              class="bg-white/5 p-2 rounded-xl group-hover:bg-brandBlue/10 transition-colors mr-4 border border-white/5"
            >
              <svg
                class="w-4 h-4 text-brandBlue"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
                stroke-width="1.5"
      ...
      <div class="flex items-center mt-8 md:mt-0 space-x-8">
        ...
        >
          <svg
            ...
            stroke="currentColor"
            viewBox="0 0 24 24"
            stroke-width="2.5"><path d="M5 10l7-7m0 0l7 7m-7-7v18" /></svg
          >
        </button>
      </div>
    </div>
